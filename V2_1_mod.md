---
title: "Optional Modification — M9OMS VLDO V2.1"
description: >-
  Oscilloscope measurements of the optional V2.1 modification: startup behaviour.
---
...
[(see the previous page)](transient.md#7-power-on-9-v-setting). This increases startup time, with **no adverse effect on
safety or operation**. This page records the captures, verifying the addition of this capacitor. A 100 nF capacitor can be tried - though this value has not been tested.
